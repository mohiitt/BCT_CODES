...
contract EmployeeData {
    ...
    // Event to log deposits made to the contract
    ...
    function getEmployee(uint index) public view returns (uint id , string memory name, string memory position, uint salary) {
